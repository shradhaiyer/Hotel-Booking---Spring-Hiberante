...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark justify-content-end ml-auto ">
    ...
    <br>
    <div class="box">
        <div class="main leftDiv">
            <br><br><br><br>
            <svg id="bb441d3c-cf2a-489d-ae6b-061a3c0e4b94" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 924.25571 530.59141">
                <path
                    ...
                    transform="translate(-137.87214 -184.7043)" fill="#6c63ff" />
                <path
                ...
                <circle cx="610.21645" cy="195.74247" r="53.51916" fill="#6c63ff" />
                <path
                ...
                <path id="fc886b53-8f7f-459a-8f46-dc88972f03c0" data-name="Path 34"
                    ...
                    transform="translate(-137.87214 -184.7043)" fill="#fff" /></svg>
        </div>
        <div class="jumbotron my-3 main rightDiv ">
            <h1 class="display-5 text-center">Welcome ${email} </h1>
            <br>
            <form class="my-3" action="http://localhost:2200/SpringFinalProject/guest" method="post">
                <div class="form-group row">
                    <label class="col-sm-5 col-form-label">Name</label>
                    <div class="col-sm-7">
                        <input type="text" name="guestName" class="form-control form-control-inline "
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="email" name="email" class="form-control form-control-inline "
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="contactNumber" class="form-control form-control-inline "
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="gender" class="form-control form-control-inline "
