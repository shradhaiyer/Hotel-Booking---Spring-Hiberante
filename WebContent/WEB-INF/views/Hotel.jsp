    ...
    <head>
		...
		<style>
		   ...
		   body{
            ...
            #leftDiv
            {
                float: left;height:415px;width:48%;
            }
            #rightDiv{
                float: right;height:400px;width:48%;
            }   
        </style>
    </head>
    <body>
        <p class="display-5">Congrats,Your registration is successful.</p>
        <br><br>
    	<div class="jumbotron-fluid float-left mx-2 my-2 px-auto py-auto" id= "leftDiv"  >
    	...
    	<div class="float-right mx-auto my-2 " id= "rightDiv">
        	<div>
            	<p class="display-6"> Hotel Name : ${hotel.hotelName}</p>
	        	<br/>
	            <p class="display-6"> Email :  ${hotel.email}</p>
	        	<br/>
	            <p class="display-6"> Contact Number : ${hotel.contactNumber}</p>
	        	<br/>
	            <p class="display-6">Street Address :  ${address.street}</p>
	        	<br/>
	        	<p class="display-6">City :  ${address.city}</p>
	        	<br/>
	        	<p class="display-6">State :  ${address.state}</p>
	        	<br/>
	        	<p class="display-6">Pincode :  ${address.pincode}</p>
	        	<br/>
	        	<p class="display-6">Room cost per day :  ${address.state}</p>
	        	<br/>
	        	<p class="display-6">Number of rooms available :  ${address.pincode}</p>
	        	<br/>
