...
<body>
	<div class="row">
		...
		<div class="logout-pos">
			<a href="http://localhost:2200/SpringFinalProject/UserLogin"><button class="btn btn-danger btn-lg">Log Out</button></a>
		</div>
		<div class="logout-pos">
			<a href="http://localhost:2200/SpringFinalProject/UserProfile/${id}"><button class="btn btn-danger btn-lg">Update Profile</button></a>
		</div>
		<div class="logout-pos">
