...
<html>
    ...
    <body>
    	...
    	<div class="float-right mx-auto my-2 " id= "rightDiv">
        	<div>
            	<p class="display-6"> Name :  ${guest.guestName}</p>
	        	<br/>
	            <p class="display-6"> Email :  ${guest.email}</p>
	        	<br/>
	            <p class="display-6"> Contact Number : ${guest.contactNumber}</p>
	        	<br/>
	            <p class="display-6"> Gender :  ${guest.gender}</p>
	        	<br/>
	        </div>
    	</div>
